...
public class PlayerManager {
    ...
    public void loadSilent(GuildMessageReceivedEvent event, String trackURL) {
        GuildMusicManager musicManager = getGuildMusicManager(event.getChannel().getGuild());
        TextChannel channel = event.getChannel();
        EmbedBuilder embedBuilder = new EmbedBuilder();
        ...
        playerManager.loadItemOrdered(musicManager, trackURL, new AudioLoadResultHandler() {
            @Override
            public void trackLoaded(AudioTrack track) {
                log.info(GREEN + "Track was silently loaded! Now playing: " + trackURL + " Title: " + track.getInfo().title + RESET);
                play(musicManager, track);
            }
    ...
    public void loadSpotify(GuildMessageReceivedEvent event, String trackURL) {
        GuildMusicManager musicManager = getGuildMusicManager(event.getChannel().getGuild());
        TextChannel channel = event.getChannel();
        EmbedBuilder embedBuilder = new EmbedBuilder();
        ...
        playerManager.loadItemOrdered(musicManager, trackURL, new AudioLoadResultHandler() {
            @Override
            public void trackLoaded(AudioTrack track) {
                log.info(GREEN + "Spotify Track was loaded! Now playing: " + trackURL + " Title: " + track.getInfo().title + RESET);
                play(musicManager, track);
            }
