...
public class MariaDBManager {
    ...
    public MariaDBManager(String host, String port, String user, String password, String dbName) {
        DB_HOST = host;
        DB_PORT = port;
        DB_USER = user;
    ...
    public void connect() {
        if (connected()) return;
        try {
            String conURI = "jdbc:mariadb://" + DB_HOST + ":" + DB_PORT + "/" + DB_NAME + "?user=" + DB_USER + "&password=" + DB_PASSWORD;
